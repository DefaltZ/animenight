...
export default function Bookmarks() {
  ...
  return (
    <div>
      <p className="text-3xl text-red-500 font-bold bg-gray-800 p-5">Welcome to your bookmarks!</p>
          ...
          {bookmarks.map((bookmark, index) => (
            <div key={index} className="lg:w-1/3 sm:w-1/2 p-4">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100" style={{ maxHeight: '100%' }}>
                  <h2 className="tracking-widest text-sm title-font font-medium text-red-400 mb-1">{bookmark.title}</h2>
