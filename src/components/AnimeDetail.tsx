            ...
            <div className="text-gray-400 bg-gray-900 body-font">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <p className="mb-8 leading-relaxed hover:text-red-500">
                        ...
                        <div className="flex w-full md:justify-start justify-center items-end">
                            <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
                                ...
                                <input
                                    ...
                                    disabled={saved}
                                    className="w-full bg-gray-800 rounded border bg-opacity-40 border-gray-700 focus:ring-2 focus:ring-red-500 focus:bg-transparent focus:border-red-400 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                    placeholder="Nickname"
                                />
                            </div>
                            <button onClick={handleSave} className="inline-flex text-red-500 border-0 py-2 px-6 focus:outline-none transition ease-in-out hover:-translate-y-1 hover:scale-110 transform duration-300 rounded text-lg">
                                {saved ? (
